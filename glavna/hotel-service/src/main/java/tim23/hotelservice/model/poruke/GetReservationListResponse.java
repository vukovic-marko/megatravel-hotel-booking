...
@XmlRootElement(name = "getReservationListResponse", namespace = "http://www.ftn.uns.ac.rs/poruke")
public class GetReservationListResponse {

    @XmlElement(name = "Reservations", required = true)
    protected List<Rezervacija> reservations;
     ...
     *     
     */
    public void setReservations(List<Rezervacija> value) {
