...
@XmlRootElement(name = "getKategorijaResponse", namespace = "http://www.ftn.uns.ac.rs/poruke")
public class GetKategorijaResponse {

    @XmlElement(name = "Kategorija_smestaja", required = true)
    protected List<KategorijaSmestaja> kategorija;
     ...
     *     
     */
    public List<KategorijaSmestaja> getKategorija() {
		return kategorija;
	}
     ...
     *     
     */
    public void setKategorija(List<KategorijaSmestaja> kategorija) {
